...
function GoPage()
{
  ...
  document.info.action="Admin_listEvaluatesSum.action";
  document.info.submit();
}
...
<body>
<div class="pageTitle">
	&nbsp;&nbsp;<img src="images/right1.gif" align="middle" /> &nbsp;<span id="MainTitle" style="color:white">教师评教&gt;&gt;教师平均得分</span>
</div>
<form name="info" id="info" action="Admin_listEvaluatesSum.action" method="post">
<input type="hidden" name="pageNo" id="pageNo" value="${pageNo}"/>
<table width="98%" align="center" cellpadding="0" cellspacing="0">
  <tr><td colspan="2" height="10px">&nbsp;</td></tr>
  <tr>
    <td width="">教师平均得分列表</td>
...
<table width="98%" align="center" class="table_list" cellpadding="0" cellspacing="0">
   <tr class="listtitle">
     ...
     <td width="60" align="center">年份</td>
   ...
   <tr class="<s:if test='(#status.index + 1)%2==0'>list1</s:if><s:else>list0</s:else>" onmouseover="tr_mouseover(this)" onmouseout="tr_mouseout(this)"> 
     ...
     <td width="" align="center"><s:property value="#evaluate.quality_score_avg"/></td>
     <td width="" align="center"><s:property value="#evaluate.post_score_avg"/></td>
     <td width="" align="center"><s:property value="#evaluate.skill_score_avg"/></td>
     <td width="" align="center"><s:property value="#evaluate.coach_score_avg"/></td>
     <td width="" align="center"><s:property value="#evaluate.plan_score_avg"/></td>
     <td width="" align="center"><s:property value="#evaluate.effect_score_avg"/></td>
     <td width="" align="center"><s:property value="#evaluate.vivid_score_avg"/></td>
     <td width="" align="center"><s:property value="#evaluate.knowledge_score_avg"/></td>
     <td width="" align="center"><s:property value="#evaluate.sum_avg"/></td>
   </tr> 
   </s:iterator>
   </s:if>
   <s:else>
   <tr>
     <td height="60" colspan="13" align="center"><b>&lt;不存在教师平均得分信息&gt;</b></td>
   </tr>
   </s:else>
