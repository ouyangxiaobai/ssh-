			  ...
			  <tr>
				...
				<div id="container">
				  ...
				  <div class="content">
					...
					<ul class="MM">
					  <li><a href="Admin_listTeachers.action" target="MainFrame">教师信息查询</a></li>
				  ...
				  <h1 class="type"><a href="javascript:void(0)">教师评教</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
					...
					<ul class="MM">
					  <li><a href="Admin_listEvaluates.action" target="MainFrame">教师评教查询</a></li>
					  <li><a href="Admin_listEvaluatesSum.action" target="MainFrame">教师平均得分</a></li>
					</ul>
				  </div>
				  </c:if>
				  <c:if test="${admin.user_type==2}">
				  <h1 class="type"><a href="javascript:void(0)">学生查询</a></h1>
				  <div class="content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  <tr>
						<td><img src="images/menu_topline.gif" width="190" height="5" /></td>
				  ...
				  <div class="content">
					...
					<ul class="MM">
					  <li><a href="Admin_listEvaluates.action" target="MainFrame">教师评教查询</a></li>
					  <li><a href="Admin_addEvaluateShow.action" target="MainFrame">新增教师评教</a></li>
					</ul>
				  </div>
				  </c:if>
