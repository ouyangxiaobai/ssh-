...
<BODY>
<div style="background-color: #76cbf4">
<FORM id="info" name="info"  method="post" action="LoginInSystem.action">
<DIV id=UpdatePanel1>
<DIV>
<TABLE style="margin: auto;" cellSpacing=0 cellPadding=0 width=900 align=center border=0>
	<TBODY>
	<TR>
			<TD style="HEIGHT: 105px"><IMG style="width: 100%" src="images/login_1.jpg" border=0></TD>
		</TR>
		
		<TR>
			<TD background=images/ height=300>
					...
					<TBODY>
						...
						<TR>
							...
							<TD style="HEIGHT: 28px" width=150>
								<select id="params.user_type" name="params.user_type" style="WIDTH: 135px">
