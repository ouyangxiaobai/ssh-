  ...
  <tr> 
   ...
   <tr>
     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
        ...
        <tr>
          <td width="15%" align="right" style="padding-right:5px">班级：</td>
          <td width="35%" colspan="3">${admin.clazz_name}</td>
        </tr> 
        <tr>
          <td align="right" style="padding-right:5px"><font color="red">*</font> 姓名：</td>
          <td>
			 <input type="hidden" id="paramsUser.real_name" name="paramsUser.real_name" value="${admin.real_name}"/>
             ${admin.real_name}
          </td>
          <td align="right" style="padding-right:5px"><font color="red">*</font> 性别：</td>
          <td>
             <input type="hidden" id="paramsUser.user_sex" name="paramsUser.user_sex" value="${admin.user_sex}"/>
             ${admin.user_sex}
          </td>
        </tr>     
         <tr>
          ...
          <td>
             <input type="hidden" id="paramsUser.user_age" name="paramsUser.user_age" value="${admin.user_age}"/>
             ${admin.user_age}
          </td> 
          <td align="right" style="padding-right:5px">平均分：</td>
          <td>
             ${admin.user_score}
          </td>
        </tr> 
         <tr>
          <td align="right" style="padding-right:5px">G点分：</td>
          <td colspan="3">
             ${admin.user_gscore}
          </td>
        </tr> 
