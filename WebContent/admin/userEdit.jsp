     ...
     <table width="100%" align="center" cellpadding="1" cellspacing="1" class="editbody">
       <tr>
        ...
        <tr>
         ...
         <tr>
          <td align="right" style="padding-right:5px">平均成绩：</td>
          <td>
            <s:textfield name="paramsUser.user_score" id="paramsUser.user_score" value="%{#attr.user.user_score}"/>
          </td> 
          <td align="right" style="padding-right:5px">G点分：</td>
          <td>
            <s:textfield name="paramsUser.user_gscore" id="paramsUser.user_gscore" value="%{#attr.user.user_gscore}"/>
          </td> 
        </tr>
        <tr>
